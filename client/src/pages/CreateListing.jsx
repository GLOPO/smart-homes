          ...
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center">
                <p>Regular Price</p>
                <span className="text-xs">(NGN / month)</span>
              </div>
            </div>
...

          {
            formData.imageUrls.length > 0 && formData.imageUrls.map((url, index) => (
              <div className="flex justify-between border p-3 items-center">
                ...
                <button className="p-3 text-red-700 rounded-lg uppercase hover:opacity-95 disabled:opacity-80" type="button" onClick={() => handleRemoveImage(index)}>delete</button>
              </div>
            ))
          }
